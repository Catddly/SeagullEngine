...
// begin seagull engine defines
#define EASTL_USER_DEFINED_ALLOCATOR 1
#define EASTL_ALLOCATOR_SG 1
#define EASTLAllocatorType eastl::allocator_sg
#define EASTLAllocatorDefault eastl::GetDefaultAllocatorSG
// end seagull engine defines
